...
/* recovery dark:  #7C4DFF #007bff
   recovery light: #F890FF #007bff
   fastbootd dark: #E65100 #007bff
   fastboot light: #FDD835 #007bff */
void ScreenRecoveryUI::SetColor(UIElement e) const {
  switch (e) {
    case UIElement::BATTERY_LOW:
      gr_color(0xff, 0x6f, 0x00, 255);
      break;
    case UIElement::INFO:
      gr_color(0x55, 0x55, 0x55, 255);
      break;
    case UIElement::HEADER:
      gr_color(0x00, 0x7b, 0xff, 255);
      break;
    case UIElement::MENU:
